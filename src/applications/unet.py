...
def UNet(weights: str = None,
    ...
    conv3 = conv_block(pool2, 256, batch_normalize=batch_normalize)
    pool3 = MaxPool2D(pool_size=(2, 2))(conv3)
    conv4 = conv_block(pool3, 512, batch_normalize=batch_normalize)
    pool4 = MaxPool2D(pool_size=(2, 2))(conv4)
    conv5 = conv_block(pool4, 1024, batch_normalize=batch_normalize)
    ...
    conv8 = conv_block(merge8, 128, batch_normalize=batch_normalize)
    upconv9 = upconv_block(conv8, 64)
    merge9 = concatenate([conv1, upconv9], axis=3)
    conv9 = conv_block(merge9, 64, batch_normalize=batch_normalize)
